...
def main() -> None:
    ...
    parser.add_argument("--suite", choices=["base", "group", "bonus", "cross", "extension"], default="base", help="Run label saved to JSON; does not filter --eval-cases.")
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="Seconds to wait between model requests; useful for free-tier rate limits.",
    )
